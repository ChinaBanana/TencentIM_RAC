 ...
 *  @param fileName 日志文件名
 *  @param tag      日志文件标签
 *  @param logId    日志文件上传事件id
 *  @param logSizeM 上传的日志文件限制，M字节
 */
-(void) uploadLogFile:(NSString*) fileName tag:(NSString*)tag logId:(NSString*)logId logSizeM:(uint32_t)logSizeM;
